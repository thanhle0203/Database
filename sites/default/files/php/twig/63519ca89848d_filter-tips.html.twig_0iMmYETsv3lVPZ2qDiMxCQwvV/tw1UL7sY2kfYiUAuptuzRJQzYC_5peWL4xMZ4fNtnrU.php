...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/drupal9/core/themes/classy/templates/content-edit/filter-tips.html.twig");
    }
